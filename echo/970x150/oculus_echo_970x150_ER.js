...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(-224,-2,1.014,1.014);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-224,-2,1288,152.2), null);
...
// stage content:
(lib.oculus_echo_970x150_ER = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	mask._off = true;
	var mask_graphics_31 = new cjs.Graphics().p("EAijADcIDcAAIAAC2IjcAAg");
	var mask_graphics_32 = new cjs.Graphics().p("EAhnACOIFxAAIAAEwIlxAAg");
	var mask_graphics_33 = new cjs.Graphics().p("EAgrABAIIHAAIAAGrIoHAAg");
	var mask_graphics_34 = new cjs.Graphics().p("AfvgNIKcAAIAAIkIqcAAg");
	var mask_graphics_35 = new cjs.Graphics().p("Ae0hbIMwAAIAAKeIswAAg");
	var mask_graphics_36 = new cjs.Graphics().p("Ad4ipIPFAAIAAMZIvFAAg");
	var mask_graphics_37 = new cjs.Graphics().p("Ac8j3IRbAAIAAOTIxbAAg");
	var mask_graphics_38 = new cjs.Graphics().p("AcAlFITwAAIAAQOIzwAAg");
	var mask_graphics_39 = new cjs.Graphics().p("AbFmTIWEAAIAASII2EAAg");
	var mask_graphics_40 = new cjs.Graphics().p("AaJnhIYZAAIAAUDI4ZAAg");
	var mask_graphics_41 = new cjs.Graphics().p("AZNovIavAAIAAV9I6vAAg");
	var mask_graphics_42 = new cjs.Graphics().p("AYSp9IdDAAIAAX3I9DAAg");
	var mask_graphics_43 = new cjs.Graphics().p("AXWrLIfYAAIAAZyI/YAAg");
	var mask_graphics_44 = new cjs.Graphics().p("AWasZMAhtAAAIAAbsMghtAAAg");
	var mask_graphics_45 = new cjs.Graphics().p("AVetnMAkDAAAIAAdnMgkDAAAg");
	var mask_graphics_46 = new cjs.Graphics().p("AUju1MAmXAAAIAAfhMgmXAAAg");
	var mask_graphics_47 = new cjs.Graphics().p("ATnwDMAosAAAMAAAAhbMgosAAAg");
	var mask_graphics_48 = new cjs.Graphics().p("ASrxRMArCAAAMAAAAjWMgrCAAAg");
	var mask_graphics_49 = new cjs.Graphics().p("ARwyfMAtWAAAMAAAAlQMgtWAAAg");
	var mask_graphics_50 = new cjs.Graphics().p("AQ0zlMAvrAAAMAAAAnLMgvrAAAg");
	...
	var mask_graphics_53 = new cjs.Graphics().p("AP10mMAyKAAAMAAAApNMgyKAAAg");
	...
	var mask_graphics_61 = new cjs.Graphics().p("APX02MAyxAAAMAAAAptMgyxAAAg");
	...
	var mask_graphics_75 = new cjs.Graphics().p("AOk1SMAz2AAAMAAAAqlMgz2AAAg");
	...
	var mask_graphics_82 = new cjs.Graphics().p("AOL1gMA0YAAAMAAAArBMg0YAAAg");
	...
	var mask_graphics_107 = new cjs.Graphics().p("AMw2SMA2SAAAMAAAAslMg2SAAAg");
	...
	var mask_graphics_113 = new cjs.Graphics().p("AMa2fMA2vAAAMAAAAs/Mg2vAAAg");
	var mask_graphics_114 = new cjs.Graphics().p("AMW2hMA20AAAMAAAAtDMg20AAAg");
	var mask_graphics_115 = new cjs.Graphics().p("AMT2jMA24AAAMAAAAtHMg24AAAg");
	...
	var mask_graphics_131 = new cjs.Graphics().p("ADq7TMBCeAAAMAAAA2nMhCeAAAg");
	...
	var mask_graphics_142 = new cjs.Graphics().p("EgMRgkFMBX0AAAMAAABILMhX0AAAg");
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(31).to({_off:false},0).to({regX:156,regY:18,scaleX:0.94,scaleY:0.94,x:691.1,y:91.3},20).wait(64).to({regX:155.9,regY:18.1,scaleX:1.59,scaleY:1.59,x:690.9,y:101.3},27,cjs.Ease.get(-1)).to({scaleX:2.18,scaleY:2.18,x:691,y:108.3,alpha:0},12).to({_off:true},1).wait(56));

	// Layer 4
	this.instance_8 = new lib.echo1_mc();
	this.instance_8.parent = this;
	this.instance_8.setTransform(482,71.3,0.069,0.069,0,0,0,63.8,131.9);
	...
	this.instance_9.setTransform(471.1,72.5,0.069,0.069,0,0,0,97.9,113.9);
	...
	this.instance_10.setTransform(475.3,71.3,0.069,0.069,0,0,0,0.8,0);
	...
	mask_1._off = true;
	var mask_1_graphics_44 = new cjs.Graphics().p("EggnAC5IAAlxMBBQAAAIAAFxg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(44).to({graphics:mask_1_graphics_44,x:258,y:49}).wait(70).to({graphics:null,x:0,y:0}).wait(97));

	// Layer 11
	this.instance_12 = new lib.text1_mc("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(252.2,84.3,1.601,1.601);
	this.instance_12._off = true;

	this.instance_13 = new lib.Tween7copy("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(252.2,49.1,1.601,1.601);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(49).to({_off:false},0).to({_off:true,y:49.1},9).wait(153));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(49).to({_off:false},9).wait(57).to({startPosition:0},0).to({scaleX:3.3,scaleY:3.3,x:208.7,y:13.4},23,cjs.Ease.get(-1)).to({scaleX:5.34,scaleY:5.34,x:148.1,y:-28.7,alpha:0},8).to({_off:true},1).wait(64));

	// Layer 8 (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_44 = new cjs.Graphics().p("EggnAC5IAAlxMBBQAAAIAAFxg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(44).to({graphics:mask_2_graphics_44,x:258,y:85.8}).wait(70).to({graphics:null,x:0,y:0}).wait(97));

	// Layer 12
	this.instance_14 = new lib.text2_mc("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(252.2,121.1,1.601,1.601);
	this.instance_14._off = true;

	this.instance_15 = new lib.Tween9("synched",0);
	this.instance_15.parent = this;
	this.instance_15.setTransform(148.1,109.7,5.336,5.336);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(54).to({_off:false},0).to({y:84.3},9).wait(52).to({startPosition:0},0).to({scaleX:3.3,scaleY:3.3,x:208.7,y:87.3},23,cjs.Ease.get(-1)).to({_off:true,scaleX:5.34,scaleY:5.34,x:148.1,y:109.7,alpha:0},8).wait(65));

	// Layer 6 (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_44 = new cjs.Graphics().p("EggnAC5IAAlxMBBQAAAIAAFxg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(44).to({graphics:mask_3_graphics_44,x:264.4,y:109.8}).wait(70).to({graphics:null,x:0,y:0}).wait(97));

	// Layer 13
	this.instance_16 = new lib.text3_mc("synched",0);
	this.instance_16.parent = this;
	this.instance_16.setTransform(380.3,140.3,1.601,1.601);
	this.instance_16._off = true;

	this.instance_17 = new lib.text3("synched",0);
	this.instance_17.parent = this;
	this.instance_17.setTransform(560.2,230.1,5.336,5.336);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(59).to({_off:false},0).to({y:109.8},9).wait(47).to({startPosition:0},0).to({scaleX:3.3,scaleY:3.3,x:465.5,y:153.3},23,cjs.Ease.get(-1)).to({_off:true,scaleX:5.34,scaleY:5.34,x:560.2,y:230.1,alpha:0},8).wait(65));
	...
	this.timeline.addTween(cjs.Tween.get(this.cta).wait(152).to({_off:false},0).wait(59));

	// legal
	this.instance_18 = new lib.legal_withpurchase();
	this.instance_18.parent = this;
	this.instance_18.setTransform(635.9,119.4,1.32,1.32,0,0,0,118,8.1);
	this.instance_18.alpha = 0;
	this.instance_18._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(161).to({_off:false},0).to({alpha:1},6).wait(44));

	// mask (mask)
	var mask_4 = new cjs.Shape();
	mask_4._off = true;
	var mask_4_graphics_154 = new cjs.Graphics().p("AtqHeIAAu7IbVAAIAAO7g");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(154).to({graphics:mask_4_graphics_154,x:641.2,y:75.7}).wait(57));

	// price
	this.instance_19 = new lib.newPrice();
	this.instance_19.parent = this;
	this.instance_19.setTransform(9.8,150.6,0.58,0.58,0,0,0,57.5,33.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(154).to({_off:false},0).to({y:72.6},10,cjs.Ease.get(1)).wait(47));

	// mask (mask)
	var mask_5 = new cjs.Shape();
	mask_5._off = true;
	var mask_5_graphics_154 = new cjs.Graphics().p("Ay/CqIAAlTMAl/AAAIAAFTg");

	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(154).to({graphics:mask_5_graphics_154,x:160.8,y:83}).wait(57));

	// oculus
	this.instance_20 = new lib.logo_oculus();
	this.instance_20.parent = this;
	this.instance_20.setTransform(219,83.9,0.198,0.198,0,0,0,156.8,111.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(154).to({_off:false},0).to({y:40.9},10,cjs.Ease.get(1)).wait(47));

	// Layer 3 (mask)
	var mask_6 = new cjs.Shape();
	mask_6._off = true;
	var mask_6_graphics_154 = new cjs.Graphics().p("Ay/C0IAAlnMAl/AAAIAAFng");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:null,x:0,y:0}).wait(154).to({graphics:mask_6_graphics_154,x:160.8,y:125}).wait(57));

	// Layer 1
	this.instance_21 = new lib.logo_rifttouch();
	this.instance_21.parent = this;
	this.instance_21.setTransform(138.6,160.3,0.576,0.576,0,0,0,86.7,166.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(154).to({_off:false},0).to({y:117.3},10,cjs.Ease.get(1)).wait(47));

	// stadium
	this.instance_22 = new lib.logo_stadium();
	this.instance_22.parent = this;
	this.instance_22.setTransform(119.5,182.3,0.496,0.496,0,0,0,81.5,66);
	this.instance_22._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(154).to({_off:false},0).to({y:139.3},10,cjs.Ease.get(1)).wait(47));

	// touch RT
	this.instance_23 = new lib.hardware_touch_RT();
	this.instance_23.parent = this;
	this.instance_23.setTransform(429.5,83.8,0.176,0.176,0,0,0,32.5,29.9);
	this.instance_23._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(143).to({_off:false},0).to({regY:30.1,scaleX:0.85,scaleY:0.85,x:327.7,y:108.3},17,cjs.Ease.get(-1)).wait(51));

	// touch LT
	this.instance_24 = new lib.hardware_touch_LT();
	this.instance_24.parent = this;
	this.instance_24.setTransform(452.1,82.7,0.176,0.176,0,0,0,23.1,23.4);
	this.instance_24._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(143).to({_off:false},0).to({scaleX:0.85,scaleY:0.85,x:453.4,y:106.4},17,cjs.Ease.get(-1)).wait(51));

	// rift
	this.instance_25 = new lib.hardware_rift();
	this.instance_25.parent = this;
	this.instance_25.setTransform(441.9,72.3,0.176,0.176,0,0,0,69,42.1);
	this.instance_25._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(143).to({_off:false},0).to({regX:69.1,scaleX:0.85,scaleY:0.85,x:402.6,y:56.2},17,cjs.Ease.get(-1)).wait(51));

	// bg
	this.instance_26 = new lib.bg();
	this.instance_26.parent = this;
	this.instance_26.setTransform(354,125,1,1,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(211));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(465,73,1288,152.2);
// library properties:
lib.properties = {
	id: '068B2C47F4684518B74A3298FE64579F',
	width: 970,
	height: 150,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Bitmap45.jpg?1502640190136", id:"Bitmap45"},
		{src:"images/echo1.jpg?1502640190136", id:"echo1"},
		{src:"images/echo2.jpg?1502640190136", id:"echo2"},
		{src:"images/echo3.jpg?1502640190136", id:"echo3"},
		{src:"images/game_1_unspoken.jpg?1502640190136", id:"game_1_unspoken"},
		{src:"images/game_2_loneecho.jpg?1502640190136", id:"game_2_loneecho"},
		{src:"images/game_3_startrek.jpg?1502640190136", id:"game_3_startrek"},
		{src:"images/game_4_superhot.jpg?1502640190136", id:"game_4_superhot"},
		{src:"images/game_5_roborecall.jpg?1502640190136", id:"game_5_roborecall"},
		{src:"images/game_6_rickmorty.jpg?1502640190136", id:"game_6_rickmorty"},
		{src:"images/game_7_wilson.jpg?1502640190136", id:"game_7_wilson"},
		{src:"images/hardware.png?1502640190136", id:"hardware"}
	],
	preloads: []
};
...
an.compositions['068B2C47F4684518B74A3298FE64579F'] = {

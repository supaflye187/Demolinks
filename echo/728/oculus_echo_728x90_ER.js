...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	mask_4._off = true;
	var mask_4_graphics_132 = new cjs.Graphics().p("AXLFSIAAqjIUfAAIAAKjg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(132).to({graphics:mask_4_graphics_132,x:279.4,y:24.7}).wait(58));

...
// stage content:
(lib.oculus_echo_300x50_DE = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	mask_4._off = true;
	var mask_4_graphics_151 = new cjs.Graphics().p("ABtDjIAAmKIOrAAIAAGKg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(151).to({graphics:mask_4_graphics_151,x:104.9,y:22.7}).wait(64));

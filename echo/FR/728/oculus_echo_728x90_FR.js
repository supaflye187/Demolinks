...
(lib.text2_mc = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(49.1,-0.2);
	...
	this.shape_1.setTransform(39.7,2);
	...
	this.shape_5.setTransform(-4.9,0.6);
	...
	this.shape_6.setTransform(-18.9,0.8);
	...
	this.shape_9.setTransform(-38.4,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-46.7,-12.2,102.9,24.4);
...
// stage content:
(lib.oculus_echo_728x90_FR = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.cta).wait(123).to({_off:false},0).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(140).to({_off:false},0).to({y:59.4,alpha:1},7).wait(43));

	// legal
	this.instance_17 = new lib.legal_withpurchase();
	this.instance_17.parent = this;
	this.instance_17.setTransform(392.3,70.6,1.052,1.052);
	this.instance_17.alpha = 0;
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(144).to({_off:false},0).to({y:62.6,alpha:1},7).wait(39));

	// mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_132 = new cjs.Graphics().p("AqOFSIAAqjIUdAAIAAKjg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(132).to({graphics:mask_3_graphics_132,x:493.2,y:24.7}).wait(58));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(132).to({_off:false},0).to({y:28.6},10,cjs.Ease.get(1)).wait(48));

	// mask (mask)
	var mask_4 = new cjs.Shape();
	mask_4._off = true;
	var mask_4_graphics_132 = new cjs.Graphics().p("AxVCaIAAkyMAirAAAIAAEyg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(132).to({graphics:mask_4_graphics_132,x:136.7,y:44.2}).wait(58));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(132).to({_off:false},0).to({y:16.6},10,cjs.Ease.get(1)).wait(48));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(127).to({_off:false},0).to({scaleX:0.63,scaleY:0.63,x:291.9,y:63.1},7,cjs.Ease.get(-1)).wait(56));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(127).to({_off:false},0).to({regY:23.5,scaleX:0.63,scaleY:0.63,x:412.2,y:56.7},7,cjs.Ease.get(-1)).wait(56));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(127).to({_off:false},0).to({scaleX:0.63,scaleY:0.63,x:355.9,y:36.4},7,cjs.Ease.get(-1)).wait(56));

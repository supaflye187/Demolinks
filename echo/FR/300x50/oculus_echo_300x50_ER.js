...
(lib.text2_mc = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(50.3,-0.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AgJAoQgJgDgHgFQgGgGgDgIQgDgFAAgNQgBgGAEgLQADgIAGgGQAHgFAJgDQAGgCANgBQAMAAAQAEIgBAYQgFgCgIgCIgNgBIgKABQgCACgDADQgCACgCAEQgBADAAAEQAAAEABAEQACAEACACQADADACABQAEACAGAAIANgCIANgDIABAYQgEACgIABIgQABQgNgBgGgCg");
	this.shape_1.setTransform(40.9,2);
	...
	this.shape_2.setTransform(31.8,2.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("");
	...
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AAAA3QgGgCgDgFQgEgEgCgGQgBgHAAgJIAAgbIgPAAIAAgWIAPAAIAAgcIAaAAIAAAcIAVAAIgBAWIgUAAIAAAZQAAAHADADQADACAGAAIAJgBIABAXQgNACgHAAQgHAAgFgBg");
	this.shape_6.setTransform(-17.7,0.8);
	...
	this.shape_9.setTransform(-37.1,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-45.4,-12.2,102.9,24.4);
...
// stage content:
(lib.oculus_echo_300x50_FR = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	mask_3._off = true;
	var mask_3_graphics_151 = new cjs.Graphics().p("AnVDFIAAmJIOrAAIAAGJg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(151).to({graphics:mask_3_graphics_151,x:170.7,y:25.7}).wait(64));

	// price
	this.instance_15 = new lib.newPrice();
	this.instance_15.parent = this;
	this.instance_15.setTransform(169.8,59.1,0.58,0.58,0,0,0,57.5,33.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(151).to({_off:false},0).to({y:24.1},10,cjs.Ease.get(1)).wait(54));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(151).to({_off:false},0).to({y:25.1},10,cjs.Ease.get(1)).wait(54));

	// bg
	this.instance_17 = new lib.bg();
	this.instance_17.parent = this;
	this.instance_17.setTransform(176,125,0.802,1,0,0,0,150.2,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(146).to({regX:150,scaleX:1,x:186.8},0).wait(69));

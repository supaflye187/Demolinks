...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	mask._off = true;
	var mask_graphics_44 = new cjs.Graphics().p("Au/BVIAAipId/AAIAACpg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(44).to({graphics:mask_graphics_44,x:83,y:130}).wait(70).to({graphics:null,x:0,y:0}).wait(97));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(49).to({_off:false},0).to({_off:true,y:130},9).wait(153));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(49).to({_off:false},9).wait(57).to({startPosition:0},0).to({scaleX:1.52,scaleY:1.52,x:82.3,y:90.8},23,cjs.Ease.get(-1)).to({scaleX:2.45,scaleY:2.45,x:82.5,y:33,alpha:0},12).to({_off:true},1).wait(60));

	// Layer 8 (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_44 = new cjs.Graphics().p("Au/BVIAAipId/AAIAACpg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(44).to({graphics:mask_1_graphics_44,x:83,y:146.9}).wait(70).to({graphics:null,x:0,y:0}).wait(97));
	...
	this.instance_3.setTransform(82.5,96.6,2.453,2.453);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(54).to({_off:false},0).to({y:146.2},9).wait(52).to({startPosition:0},0).to({scaleX:1.52,scaleY:1.52,x:82.3,y:124.8},23,cjs.Ease.get(-1)).to({_off:true,scaleX:2.45,scaleY:2.45,x:82.5,y:96.6,alpha:0},12).wait(61));

	// Layer 6 (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_44 = new cjs.Graphics().p("Au/BVIAAipId/AAIAACpg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(44).to({graphics:mask_2_graphics_44,x:83,y:163.9}).wait(70).to({graphics:null,x:0,y:0}).wait(97));
	...
	this.instance_5.setTransform(269,157.9,2.453,2.453);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(59).to({_off:false},0).to({regY:0,y:163.9},9).wait(47).to({startPosition:0},0).to({regX:0,scaleX:1.52,scaleY:1.52,x:197.5,y:161},23,cjs.Ease.get(-1)).to({_off:true,scaleX:2.45,scaleY:2.45,x:269,y:157.9,alpha:0},12).wait(61));

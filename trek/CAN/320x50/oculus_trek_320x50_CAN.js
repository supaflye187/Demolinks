...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AANCyIAAhCIieAAIAAhEICejdIBQAAIAADdIA1AAIgDBEIgyAAIAABCgAg8AsIBJAAIAAhmIgBAAg");
	this.shape_2.setTransform(57.7,22.1);
...
(lib.legal_withpurchase = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(220.1,10.5);
	...
	this.shape_1.setTransform(214.9,6.7);
	...
	this.shape_2.setTransform(208.3,8.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("");
	this.shape_3.setTransform(201.3,6.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AgMAaQgEgBgDgDIgDgHIgBgIIAAgiIAHAAIAAAhIABAGQABADACACIADAEIAHABQAEAAADgCQADgBADgDIAFgIQABgFAAgEIAAgaIAHAAIAAA2IgHAAIAAgLIAAAAQgEAGgEADIgFACIgHABQgFAAgEgCg");
	this.shape_4.setTransform(194.6,8.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AgDArIAAhVIAHAAIAABVg");
	this.shape_5.setTransform(189.9,6.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AgFAbQgFgBgEgEQgFgEgBgFQgCgEAAgJQAAgEACgIQABgGAFgEQAEgDAFgBQAFgCAGAAIAJABIAJADIgBAHIgJgEIgIgBQgFAAgDABQgFACgDADQgDADgBAEQgCAEAAAFQAAAGACAEQABAEADADQADADAFABQADACAFgBIAIgBIAJgCIABAGIgJADIgJABQgGAAgFgCg");
	this.shape_6.setTransform(185.7,8.2);
	...
	this.shape_7.setTransform(179.4,8.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("AgCApIAAg3IAGAAIAAA3gAgDgeQAAgBAAAAQgBAAAAgBQAAgBAAAAQAAgBAAAAQAAgBAAAAQAAgBAAAAQAAgBABAAQAAAAAAgBQABAAAAgBQABAAAAAAQABgBAAAAQAAAAAAAAQABAAAAAAQABAAAAABQABAAAAAAQABABAAAAIABAEIgBAEQAAAAgBAAQAAABgBAAQAAAAgBAAQAAAAgBAAQAAAAAAAAQAAAAgBAAQAAAAgBgBQAAAAgBAAg");
	this.shape_8.setTransform(174.7,6.9);
	...
	this.shape_11.setTransform(156.1,8.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#000000").s().p("");
	this.shape_12.setTransform(147.2,8.2);
	...
	this.shape_13.setTransform(141.5,8.2);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#000000").s().p("");
	this.shape_14.setTransform(133.1,8.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#000000").s().p("");
	this.shape_15.setTransform(124.6,8.2);
	...
	this.shape_16.setTransform(117.8,9.6);
	...
	this.shape_17.setTransform(108.2,8.2);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#000000").s().p("");
	this.shape_18.setTransform(99.8,8.1);
	...
	this.shape_19.setTransform(91.2,8.2);
	...
	this.shape_20.setTransform(84.3,6.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.legal_withpurchase, new cjs.Rectangle(78,-3,146.6,19.6), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_3.setTransform(134.6,-166.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AgIATQgDgCgDgDQgCgCgCgEIgBgIIABgHIAEgGQADgDADgCIAIgBIAIABQAEACADADIADAGQACAEAAADQAAAEgCAEQgBAEgCACQgDADgEACIgIABIgIgBgAgGgNIgFADIgCAFIgBAFIABAGIACAFIAFAEIAGABIAHgBIAFgEIACgFIABgGIgBgFIgCgFQgDgCgCgBQgDgCgEAAQgDAAgDACg");
	this.shape_4.setTransform(129.9,-166);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AgFATQgEgBgDgDQgCgCgBgEIgCgJIACgIIADgGQADgDAEgBIAFgBQAFAAACABQADABADADQADACAAAEQACAEAAAEIAAACIgeAAIABAGIADAFIAFACIAFABIAHgBIAHgCIAAAFIgHACIgGAAIgIgBgAANgBIgBgGIgDgEIgEgDIgFgBIgDABIgFACIgDAFQgBACAAAEIAZAAIAAAAg");
	this.shape_5.setTransform(123.2,-166);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AAZAUIAAgXIgBgEIgBgEIgDgCIgEgBIgFABIgFADIgCAFIgBAFIAAAUIgFAAIAAgXIAAgEIgBgEIgDgCIgFgBIgFABIgEADQgCACAAADIgBAGIAAATIgGAAIAAgmIAGAAIAAAIIACgDIACgDIAFgCIAEgBIAGABIADACIABADIACAFIADgFIACgDIAFgCIAFgBQADAAADACIAEADIACAFIABAGIAAAXg");
	this.shape_6.setTransform(117.4,-166.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("AgCAcIAAglIAEAAIAAAlgAgCgVIgBgCIABgDIACgBIADABIABADIgBACIgDABIgCgBg");
	this.shape_7.setTransform(112.8,-166.9);
	...
	this.shape_8.setTransform(110.5,-166.5);
	...
	this.shape_9.setTransform(104.5,-167);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#000000").s().p("AgFATQgEgBgDgDQgCgCgBgEIgCgJIACgIIADgGQADgDAEgBIAGgBQADAAADABQAEABACADQADACAAAEQACAEAAAEIAAACIgeAAIABAGIAEAFIAEACIAFABIAHgBIAHgCIAAAFIgGACIgHAAIgIgBgAANgBIgBgGIgCgEIgFgDIgEgBIgFABIgDACIgEAFQgBACAAAEIAZAAIAAAAg");
	this.shape_10.setTransform(99.9,-166);
	...
	this.shape_11.setTransform(96.3,-166.5);
	...
	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#000000").s().p("AAZAUIAAgXIAAgEIgCgEIgDgCIgEgBIgGABIgDADIgEAFIgBAFIAAAUIgDAAIAAgXIgBgEIgCgEIgCgCIgEgBIgGABIgEADQgCACgBADIgBAGIAAATIgEAAIAAgmIAEAAIAAAIIACgDIAEgDIADgCIAGgBIAEABIAEACIACADIABAFIACgFIAEgDIAEgCIAFgBQADAAADACIAEADIACAFIAAAGIAAAXg");
	this.shape_13.setTransform(89.4,-166.1);
...
}).prototype = getMCSymbolPrototype(lib.legal_limitedtime, new cjs.Rectangle(77.6,-173.8,69.4,13.6), null);
...
// stage content:
(lib.oculus_trek_320x50_CAN = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(153).to({graphics:mask_3_graphics_153,x:170.1,y:40.3}).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(150).to({graphics:mask_4_graphics_150,x:170.1,y:33.1}).wait(53));
	...
	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(147).to({graphics:mask_5_graphics_147,x:182.3,y:17.5}).wait(56));

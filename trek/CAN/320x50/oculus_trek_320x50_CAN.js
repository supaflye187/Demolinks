...
(lib.newPrice = function(mode,startPosition,loop) {
	...
	this.shape_2.setTransform(58.1,22.1);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_12}]},51).to({state:[{t:this.instance_12}]},9).to({state:[{t:this.instance_12}]},54).to({state:[{t:this.instance_12}]},29).to({state:[{t:this.instance_13}]},9).to({state:[]},1).wait(57));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_14}]},53).to({state:[{t:this.instance_14}]},9).to({state:[{t:this.instance_14}]},52).to({state:[{t:this.instance_14}]},29).to({state:[{t:this.instance_15}]},9).to({state:[]},1).wait(57));
	...
	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(146).to({graphics:mask_3_graphics_146,x:173.2,y:25.7}).wait(64));

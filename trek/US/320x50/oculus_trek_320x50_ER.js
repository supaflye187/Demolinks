...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(44).to({graphics:mask_graphics_44,x:69.1,y:18}).wait(71).to({graphics:null,x:0,y:0}).wait(95));

	// Layer 11
	this.instance_10 = new lib.text1_mc("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(67.2,29.7,0.533,0.533,0,0,0,0.2,0.2);
	this.instance_10._off = true;

	this.instance_11 = new lib.Tween7("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(67.2,18,0.533,0.533,0,0,0,0.2,0.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(49).to({_off:false},0).to({_off:true,y:18},9).wait(152));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(49).to({_off:false},9).wait(56).to({startPosition:0},0).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:-135.4,y:8.7},29,cjs.Ease.get(-1)).to({regX:0.1,regY:-0.1,scaleX:1.78,scaleY:1.78,x:-201.1,y:7.7,alpha:0},9).to({_off:true},1).wait(57));
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(44).to({graphics:mask_1_graphics_44,x:69.1,y:30.2}).wait(71).to({graphics:null,x:0,y:0}).wait(95));

	// Layer 12
	this.instance_12 = new lib.text2_mc("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(67.2,41.9,0.533,0.533,0,0,0,0.2,0.1);
	this.instance_12._off = true;

	this.instance_13 = new lib.Tween9("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(-201.1,53.7,1.776,1.776,0,0,0,0.1,-0.1);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_12}]},51).to({state:[{t:this.instance_12}]},9).to({state:[{t:this.instance_12}]},54).to({state:[{t:this.instance_12}]},29).to({state:[{t:this.instance_13}]},9).to({state:[]},1).to({state:[]},55).wait(2));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(51).to({_off:false},0).to({regY:0.2,y:29.7},9).wait(54).to({startPosition:0},0).to({regX:0.1,regY:0.1,scaleX:1.1,scaleY:1.1,x:-135.3,y:33.2},29,cjs.Ease.get(-1)).to({_off:true,regY:-0.1,scaleX:1.78,scaleY:1.78,x:-201.1,y:53.7,alpha:0},9).wait(58));
	...
	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(44).to({graphics:mask_2_graphics_44,x:71.5,y:37.7}).wait(71).to({graphics:null,x:0,y:0}).wait(95));

	// Layer 13
	this.instance_14 = new lib.text3_mc("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(110.1,47.9,0.533,0.533,0,0,0,0.2,0.3);
	this.instance_14._off = true;

	this.instance_15 = new lib.text3("synched",0);
	this.instance_15.parent = this;
	this.instance_15.setTransform(-63.7,93.5,1.776,1.776,0,0,0,0.1,0.1);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_14}]},53).to({state:[{t:this.instance_14}]},9).to({state:[{t:this.instance_14}]},52).to({state:[{t:this.instance_14}]},29).to({state:[{t:this.instance_15}]},9).to({state:[]},1).to({state:[]},55).wait(2));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(53).to({_off:false},0).to({regY:0.2,y:37.7},9).wait(52).to({startPosition:0},0).to({regX:0.1,regY:0.1,scaleX:1.1,scaleY:1.1,x:-49.6,y:54.7},29,cjs.Ease.get(-1)).to({_off:true,scaleX:1.78,scaleY:1.78,x:-63.7,y:93.5,alpha:0},9).wait(58));
	...
	this.timeline.addTween(cjs.Tween.get(this.cta).wait(133).to({_off:false},0).to({alpha:1},4).wait(73));

	// mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_146 = new cjs.Graphics().p("ADzDjIAAmKIM/AAIAAGKg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(146).to({graphics:mask_3_graphics_146,x:107.4,y:22.7}).wait(64));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(146).to({_off:false},0).to({y:24.1},10,cjs.Ease.get(1)).wait(54));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(146).to({_off:false},0).to({y:25.1},10,cjs.Ease.get(1)).wait(54));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Bitmap14.jpg?1502948031747", id:"Bitmap14"},
		{src:"images/Bitmap16.jpg?1502948031747", id:"Bitmap16"},
		{src:"images/Bitmap34.jpg?1502948031747", id:"Bitmap34"},
		{src:"images/flare.png?1502948031747", id:"flare"},
		{src:"images/game_1_unspoken.jpg?1502948031747", id:"game_1_unspoken"},
		{src:"images/game_2_loneecho.jpg?1502948031747", id:"game_2_loneecho"},
		{src:"images/game_3_startrek.jpg?1502948031747", id:"game_3_startrek"},
		{src:"images/game_4_superhot.jpg?1502948031747", id:"game_4_superhot"},
		{src:"images/game_5_roborecall.jpg?1502948031747", id:"game_5_roborecall"},
		{src:"images/game_6_rickmorty.jpg?1502948031747", id:"game_6_rickmorty"},
		{src:"images/game_7_wilson.jpg?1502948031747", id:"game_7_wilson"}
	],
	preloads: []
};
